...
with torch.no_grad():
    for img_no in range(ImgNum):
        ...
        lf_pred_2d = np.transpose(lf, axes=[2, 0, 3, 1]).reshape(504*4, 504*4)
        io.imsave("%s_LF_ratio_%d_epoch_%d_PSNR_%.2f_SSIM_%.4f.png" % (
